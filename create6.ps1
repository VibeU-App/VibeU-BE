...
export class PostController {
  ...
  @ApiCreatedResponseEnvelope({ description: 'Post created successfully', type: PostEntity })
  async createPost(
    @Body() dto: CreatePostDto,
    @CurrentUser() user: TokenPayload,
  ): Promise<Envelope<PostEntity>> {
    const post = await this.createPostUsecase.execute(user.sub, dto.content, dto.mediaUrls);
    return { data: post, statusCode: HttpStatus.CREATED, message: 'Post created successfully' };
  }

  @Patch(':id/pin')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Pin or unpin a post' })
  @ApiOkResponseEnvelope({ description: 'Post pin status updated successfully', type: PostEntity })
  async pinPost(
    @Param('id') id: string,
    @Body() dto: PinPostDto,
    @CurrentUser() user: TokenPayload,
  ...
  async deletePost(
    ...
    return { data: null, statusCode: HttpStatus.OK, message: 'Post deleted successfully' };
  }
  ...
  async getTimelineFeed(
    ...
    return { data: result, statusCode: HttpStatus.OK, message: 'Timeline feed retrieved successfully' };
  }
  ...
  async addComment(
    ...
    return { data: comment, statusCode: HttpStatus.CREATED, message: 'Comment added successfully' };
  }
  ...
  async getProfileFeed(
    ...
    return { data: result, statusCode: HttpStatus.OK, message: 'Profile feed retrieved successfully' };
  }
  ...
  async getPostDetails(
    ...
    return { data: post, statusCode: HttpStatus.OK, message: 'Post retrieved successfully' };
  }
  ...
  async getComments(
    ...
    return { data: result, statusCode: HttpStatus.OK, message: 'Comments retrieved successfully' };
  }
}
'@
...
export * from './timeline-feed-query.dto';
export * from './create-comment.dto';
export * from './profile-feed-query.dto';
'@
Set-Content -Path "src/controllers/dto/post/index.ts" -Value $content -Encoding UTF8

Write-Host "Created PostController and exported DTOs"
